                ...
                <v-footer height="auto" app fixed>
                    <v-layout row wrap>
                        ...
                        <v-flex xs-8 v-if="!usernameChosen">
                            ...
                            <v-text-field solo class='usernameInput' v-model="username" @keydown.enter="usernameFormSubmit" type='text'
...
export default {
  ...
  methods: {
    usernameFormSubmit(e) {
      ...
      if (this.$data.username.trim().length > 0) {
        console.log("username is " + this.$data.username.trim());
        ...
        this.$data.messages.push({
          ...
          username: "system",
          messageText: this.$data.username.trim() + " has joined.",
          private: false
        });
        this.$data.lastToMessage = "system";
        this.$data.usernameChosen = true;
        this.$data.messagingChat = true;
        this.$data.usernameID++;
        this.$data.messageID++;
        console.log("username id is now " + this.$data.usernameID);
        console.log("message id is now " + this.$data.messageID);
      }
    },
    messageFormSubmit(e) {
      e.preventDefault();
  ...
  watch: {
    ...
    <style>
        ...
        .chatMessageInput, .usernameInput {
          max-height: 48px;
        }
    </style>